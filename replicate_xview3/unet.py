# Vendored from https://github.com/selimsef/xview3_solution (Apache-2.0),
# 2nd-place solution of the xView3 dark-vessel detection challenge.
# Model: TimmUnet (resnet34 encoder, 2-ch VV+VH input) with four dense
# heads: center/vessel/fishing/length masks.
import os
